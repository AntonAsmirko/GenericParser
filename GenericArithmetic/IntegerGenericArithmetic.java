...
public class IntegerGenericArithmetic extends AbstractGenericArithmetic<Integer> {
    ...
    private BiFunction<AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>> log2 = (
            first, second) -> new IntegerGenericArithmetic((int) (Math.log(first.getValue()) / Math.log(2)));

    private BiFunction<AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>> pow2 = (
            first, second) -> new IntegerGenericArithmetic((int) Math.pow(2, first.getValue()));
    ...
    private BiFunction<AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>> max = (
            first, second) -> new IntegerGenericArithmetic(Math.max(first.getValue(), second.getValue()));

    private BiFunction<AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>> min = (
            first, second) -> new IntegerGenericArithmetic(Math.min(first.getValue(), second.getValue()));

    private BiFunction<AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>, AbstractGenericArithmetic<Integer>> count = (
            first, second) -> new IntegerGenericArithmetic(Integer.bitCount(first.getValue()));
