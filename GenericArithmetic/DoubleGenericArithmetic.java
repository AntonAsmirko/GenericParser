...
public class DoubleGenericArithmetic extends AbstractGenericArithmetic<Double> {
    ...
    public DoubleGenericArithmetic(Double val) {
        super(val);
    }
    ...
    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> add = (first, second) ->
            new DoubleGenericArithmetic(first.getValue() + second.getValue());

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> subtract = (first, second) ->
            new DoubleGenericArithmetic(first.getValue() - second.getValue());

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> multiply = (first, second) ->
            new DoubleGenericArithmetic(first.getValue() * second.getValue());

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> divide = (first, second) ->
            new DoubleGenericArithmetic(first.getValue() / second.getValue());

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> log2 = (first, second) ->
            new DoubleGenericArithmetic((Math.log(first.getValue()) / Math.log(2)));

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> pow2 = (first, second) ->
            new DoubleGenericArithmetic(Math.pow(2, first.getValue()));

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> negate = (first, second) ->
            new DoubleGenericArithmetic(-first.getValue());

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> max = (first, second) ->
            new DoubleGenericArithmetic(Math.max(first.getValue(), second.getValue()));

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> min = (first, second) ->
            new DoubleGenericArithmetic(Math.min(first.getValue(), second.getValue()));

    private Function<Double, Long> countOnes = val ->
            Long.toBinaryString(Double.doubleToRawLongBits(val)).chars().filter(i -> i == '1').count();

    private BiFunction<AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>,
            AbstractGenericArithmetic<Double>> count = (first, second) ->
            new DoubleGenericArithmetic(Double.valueOf(countOnes.apply(first.getValue())));
}
