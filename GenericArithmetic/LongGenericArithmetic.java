...
public class LongGenericArithmetic extends AbstractGenericArithmetic<Long> {
    ...
    public LongGenericArithmetic(Long val) {
        super(val);
    }
    ...
    private BiFunction<AbstractGenericArithmetic<Long>,
                AbstractGenericArithmetic<Long>,
                AbstractGenericArithmetic<Long>> add = (first, second) ->
            new LongGenericArithmetic(first.getValue() + second.getValue());

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> subtract = (first, second) ->
            new LongGenericArithmetic(first.getValue() - second.getValue());

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> multiply = (first, second) ->
            new LongGenericArithmetic(first.getValue() * second.getValue());

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> divide = (first, second) ->
            new LongGenericArithmetic(first.getValue() / second.getValue());

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> log2 = (first, second) ->
            new LongGenericArithmetic((long) (Math.log(first.getValue()) / Math.log(2)));

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> pow2 = (first, second) ->
            new LongGenericArithmetic((long) Math.pow(2, first.getValue()));

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> negate = (first, second) ->
            new LongGenericArithmetic(-first.getValue());

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> max = (first, second) ->
            new LongGenericArithmetic(Math.max(first.getValue(), second.getValue()));

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> min = (first, second) ->
            new LongGenericArithmetic(Math.min(first.getValue(), second.getValue()));

    private BiFunction<AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>,
            AbstractGenericArithmetic<Long>> count = (first, second) ->
            new LongGenericArithmetic((long)Long.bitCount(first.getValue()));
}
